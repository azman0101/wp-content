<?php
/**
 * About NatureSpace admin page framework.
 * @package NatureSpace
 * @since NatureSpace 2.0.0
*/   

add_action('admin_init', 'naturespace_about_setup');
function naturespace_about_setup() {
$naturespace_about = array (

array( "name" => __( 'NatureSpace' , 'naturespace' ),
	"type" => "title"),
...
array( "name" => "Start Tabs",
	...
	// Home
	array( "name" => __( '<i class="icon_house" aria-hidden="true"></i>Welcome' , 'naturespace' ),
			"id" => "tab_menu_0",
			"type" => "tab",
			"icon" => "layout",
  ...
  // Get Premium
	array( "name" => __( '<i class="icon_cart" aria-hidden="true"></i>GET PREMIUM' , 'naturespace' ),
			"type" => "tab",
			"id" => "tab_menu_1",
			"class" => ""),
...
array( "name" => "tab_content_0",
	...
	// Home
	array( "name" => __( 'Welcome to NatureSpace!' , 'naturespace' ),
		"type" => "heading",
		"icon" => "layout"),
	
	array("name" => __( 'First of all, I would like to thank you for choosing the NatureSpace theme! I firmly believe that you will be satisfied with this template.' , 'naturespace' ),
		"type" => "infotext"),
	
	array( "name" => __( 'About NatureSpace' , 'naturespace' ),
		"type" => "heading",
		"icon" => "layout"),
	
	array("name" => __( 'NatureSpace is an easily customizable WordPress multipurpose theme. It is a fully responsive and Retina ready theme that allows for easy viewing on any device.' , 'naturespace' ),
		"type" => "infotext"),
    
	array("name" => __( 'Since version 2.0.0, the Theme Options have been moved to the <a href="customize.php">Customizer</a>.' , 'naturespace' ),
		"type" => "infotext"),
...
array( "name" => "tab_content_1",
	...
	array( "name" => __( 'Get NatureSpace Premium Version' , 'naturespace' ),
		"type" => "heading",
		"icon" => "layout"),
		
  array( "type" => "infotext",
		"name" => __( 'If you would like to purchase the NatureSpace Premium Version, you can do so on <a href="http://themes.tomastoman.cz/downloads/naturespace-premium/" target="_blank">Developers Official Website</a>.' , 'naturespace' )),
    
  array( "type" => "infotext",
		"name" => __( '<strong>What the NatureSpace Premium Version offers in addition?</strong><br />
    ...
    - Ability to add custom JavaScript code' , 'naturespace' )),
...
function naturespace_add_admin() {
	add_theme_page( __( 'About NatureSpace' , 'naturespace' ), __( 'About NatureSpace' , 'naturespace' ), 'edit_theme_options', 'about.php', 'naturespace_admin', '', '1' );
}

function naturespace_admin() {
$naturespace_about = naturespace_about_setup(); 
  wp_enqueue_style('naturespace-framework-style', get_template_directory_uri() . '/functions/about/css.css');
  wp_enqueue_style('naturespace-framework-icons', get_template_directory_uri() . '/css/elegantfont.css');
  $naturespace_manualurl = get_template_directory_uri() . '/docs/documentation.html';
?>

	<div id="wrap_fm"><!-- [ Header ]-->
		<div class="header_fm">
			<div class="logo_fm"><?php _e( 'NatureSpace Theme' , 'naturespace' ); ?></div>
		</div>

		<!-- [ Top Menu ]-->
		<div class="top_menu_fm">
			<a target="_blank" class="doc_fm" href="<?php echo esc_url($naturespace_manualurl); ?>"><?php _e( 'Documentation' , 'naturespace' ); ?></a><a target="_blank" class="support_fm" href="http://themes.tomastoman.cz/support"><?php _e( 'Support' , 'naturespace' ); ?></a><a target="_blank" class="premium_fm" href="http://themes.tomastoman.cz/downloads/naturespace-premium/"><?php _e( 'Get Premium Version' , 'naturespace' ); ?></a>
		</div>

	<?php 
	foreach ($naturespace_about as $value) {
	switch ( $value['type'] ) {
	case "open":
	?> 
