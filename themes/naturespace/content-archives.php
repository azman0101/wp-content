...
<?php if ( get_theme_mod('naturespace_display_meta_post_entry', naturespace_default_options('naturespace_display_meta_post_entry')) != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php } ?>
        <div class="post-entry-content"><?php if ( get_theme_mod('naturespace_content_archives', naturespace_default_options('naturespace_content_archives')) != 'Content' ) { ?><?php the_excerpt(); ?><?php } else { ?><?php global $more; $more = 0; ?><?php the_content(); ?><?php } ?></div>
    </article>