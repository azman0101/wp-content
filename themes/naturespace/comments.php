...
if ( post_password_required() )
	return;
?>
<div id="comments" class="comments-area<?php if ( get_theme_mod('naturespace_next_preview_post', naturespace_default_options('naturespace_next_preview_post')) == 'Display' || get_theme_mod('naturespace_next_preview_post', naturespace_default_options('naturespace_next_preview_post')) == '' ) { ?> comments-area-post<?php } ?>">
