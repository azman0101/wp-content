...
/**
 * NatureSpace theme specific functions and customizer.
 *  
*/    
// Set path to NatureSpace theme specific functions
$naturespace_fe_path = get_template_directory() . '/functions/fe/';    
// Include Theme specific functionality [FE] 
require_once ($naturespace_fe_path . 'headerdata.php');
require_once ($naturespace_fe_path . 'library.php');
// Include Theme Customization admin screen  
require_once (get_template_directory() . '/functions/customizer.php');
// Include About NatureSpace admin page 
...
function naturespace_scripts_styles() {
    ...
    if ( get_theme_mod('naturespace_post_entry_format', naturespace_default_options('naturespace_post_entry_format')) == 'Grid - Masonry' ) {
    ...
    if ( has_nav_menu( 'main-navigation' ) && get_theme_mod('naturespace_header_layout', naturespace_default_options('naturespace_header_layout')) == 'Centered' && !is_page_template('template-landing-page.php') ) {
...
if (get_theme_mod('naturespace_excerpt_length') != '') {
return esc_attr(get_theme_mod('naturespace_excerpt_length'));
} else { return 40; }
}
...
add_action( 'naturespace_register', 'naturespace_my_theme_register_required_plugins' );
