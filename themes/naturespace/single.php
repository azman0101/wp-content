...
<?php if ( get_theme_mod('naturespace_display_meta_post', naturespace_default_options('naturespace_display_meta_post')) != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php endwhile; endif; ?>
<?php if ( get_theme_mod('naturespace_next_preview_post', naturespace_default_options('naturespace_next_preview_post')) != 'Hide' ) { ?>
<?php naturespace_prev_next('naturespace-post-nav'); ?>
<?php } ?> 
<?php comments_template( '', true ); ?>
    </article> <!-- end of content -->
  </div>
<?php if (get_theme_mod('naturespace_display_sidebar', naturespace_default_options('naturespace_display_sidebar')) != 'Hide') { ?>
<?php get_sidebar(); ?>
<?php } ?>
  </div>
