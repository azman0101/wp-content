...
if( ! function_exists( 'avia_woocommerce_frontend_search_params' ) )
{
	...
	function avia_woocommerce_frontend_search_params()
	{
		...
		$default_tip = 'title="' . esc_attr( __( 'Setting from Dashboard -&gt; Appearance -&gt; Customize -&gt; WooCommerce -&gt; Product Catalog -&gt; Default Product Sorting', 'avia_framework' ) ) . '"';
...
//		$ps_key = ! empty( $avia_config['woocommerce']['product_sort'] ) ? $avia_config['woocommerce']['product_sort'] : $params['product_sort'];
		...
		$output .= "    	<ul>";
		$output .= "    	<li".avia_woo_active_class($po_key, 'default')."><a href='".avia_woo_build_query_string( $params, 'product_order', 'default', 'product_sort' )."' {$nofollow} {$default_tip}>	<span class='avia-bullet'></span>".$product_order['default']."</a></li>";
		...
		$output .= "    	<li".avia_woo_active_class($po_key, 'menu_order')."><a href='".avia_woo_build_query_string($params, 'product_order', 'menu_order')."' {$nofollow}>	<span class='avia-bullet'></span>".$product_order['menu_order']."</a></li>";
		...
		$output .= "    	<li".avia_woo_active_class($po_key, 'rating')."><a href='".avia_woo_build_query_string($params, 'product_order', 'rating')."' {$nofollow}>	<span class='avia-bullet'></span>".$product_order['rating']."</a></li>";
		$output .= "    	<li".avia_woo_active_class($po_key, 'relevance')."><a href='".avia_woo_build_query_string($params, 'product_order', 'relevance')."' {$nofollow}>	<span class='avia-bullet'></span>".$product_order['relevance']."</a></li>";
		$output .= "    	<li".avia_woo_active_class($po_key, 'rand')."><a href='".avia_woo_build_query_string($params, 'product_order', 'rand')."' {$nofollow}>	<span class='avia-bullet'></span>".$product_order['rand']."</a></li>";
		$output .= "    	<li".avia_woo_active_class($po_key, 'id')."><a href='".avia_woo_build_query_string($params, 'product_order', 'id')."' {$nofollow}>	<span class='avia-bullet'></span>".$product_order['id']."</a></li>";
		$output .= "    	</ul>";
		$output .= "    	</li>";
		$output .= "    </ul>";
